...
#cs ----------------------------------------------------------------------------
 ...
 Function: findImagesFilesWait

Uses the same functions as findImagesWait with combination to findImageFiles
...
Func findImagesFilesWait($strImages, $intDuration = 5, $intTolerance = 10)
	Local $arrayImages[0] ;images list to find
