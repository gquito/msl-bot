...
GUICtrlCreateGroup("config.ini", 4, 21, 274, 134)
...
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
Global $btnCopyPoints = GUICtrlCreateButton("Copy Points: ", 11, 127, 70, 25)
GUICtrlSetOnEvent(-1, "btnCopyPointsClick")
Global $lblDebugCoordinations = GUICtrlCreateLabel("F6: (?, ?) | F7: (?, ?)", 83, 131, 265, 17)
...
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
Global $lblVersion = GUICtrlCreateLabel("Author: GkevinOD", 12, 77, 250, 17)
GUICtrlSetFont(-1, 8, 400, 0, "Arial")
