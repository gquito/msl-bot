...
; Random click spread
Global Const $g_aRandomClicks = [-5, 5] 
; enum _BKGD_TYPE
...
Global Const $g_sRemoteUrl = "https://raw.githubusercontent.com/GkevinOD/msl-bot/version-check/msl-bot/"
...
Global Const $d_sProfilePath = $g_sProfileFolder & $d_sProfile & "\" ;Path to current seleted profile
Global Const $d_sAdbDevice = "127.0.0.1:62001" ;Android debug bridge device name. Default is 127.0.0.1:62001 for nox
Global Const $d_sAdbPath = "C:\Program Files (x86)\Nox\bin\nox_adb.exe" ;Android adb executable. Default for nox
Global Const $d_sAdbMethod = "input event" ;Method to send clicks and keypresses to the ADB.
