		...
		Switch $sLocation
			Case "battle-end"
				If clickWhile(getArg($g_aPoints, "quick-restart"), "isLocation", "battle-end", 10, 100) = True Then
					Switch waitLocation("battle-auto,battle,refill,map-battle,map-gem-full,battle-gem-full,map-astromon-full,astromon-full,buy-gem,gold-dungeons,guardian-dungeons,special-guardian-dungeons", 120, False)
			...
			Case "map-battle"
				If clickWhile(getArg($g_aPoints, "map-battle-play"), "islocation", "map-battle", 10, 100) = True Then
					Switch waitLocation("loading,battle-auto,battle,refill,map-gem-full,battle-gem-full,map-astromon-full,astromon-full,buy-gem", 120, False)
