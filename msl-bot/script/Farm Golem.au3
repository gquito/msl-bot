...
Func farmGolem()
	...
	farmGolemMain($strGolem, $selectBoss, $sellGems, $intSellGradeMin, $intKeepGradeMinSub, $intMinSub, $intGem, $guardian, $quest, $hourly)
EndFunc
...
#cs
	...
	Author: GkevinOD (2017)
#ce
Func farmGolemMain($strGolem, $selectBoss, $sellGems, $intSellGradeMin, $intKeepGradeMinSub, $intMinSub, $intGem, $guardian, $quest, $hourly)
